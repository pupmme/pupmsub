...
install_V2bX() {
    ...
    file="https://raw.githubusercontent.com/pupmme/pupmsub/script/V2bX.service"
    ...
    curl -o /usr/bin/V2bX -Ls https://raw.githubusercontent.com/pupmme/pupmsub/script/V2bX.sh
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://raw.githubusercontent.com/pupmme/pupmsub/script/initconfig.sh
